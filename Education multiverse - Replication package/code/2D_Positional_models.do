...
keep qgeduyrs25 qgeduyrs30 qgtyrsa qgtyrsfa qgtyrsma qgtyrspda qgtyrspaa ///
age2465 age2535 age2565 age2569 age2570 age2574 age25pl age2746 ///
age2747 age2855 age2933 age30pl brncntr cntry gndr
 
compress
save 						"ESS_1-10_pos.dta", replace
use 						"ESS_1-10_pos.dta"
...
scalar aa = 0
	foreach c_educ in qgeduyrs25 qgeduyrs30 qgtyrsa { 
		scalar aa = aa + 1

* Setting dominance, the choice here should define the varlist in the next loop
scalar bb = 0
	foreach par_meas in "qgtyrspda" "qgtyrspaa" "qgtyrsfa" "qgtyrsma" {  
		scalar bb = bb + 1
...
svmat m
drop in 1
save						"models_pos.dta", replace
use							"models_pos.dta", clear
...
save						"models_pos_raw.dta", replace
use							"models_pos_raw.dta", clear
