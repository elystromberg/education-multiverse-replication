*==============================================================================*
* Multiverse of continuous models calculating regression coefficients 
*==============================================================================*
...
scalar aa = 0
	foreach c_educ in c_ed_30 c_ed_25 tyrsa { 
		scalar aa = aa + 1

* Setting dominance, the choice here should define the varlist in the next loop
scalar bb = 0
	foreach par_meas in "tyrspda" "tyrspaa" "tyrsfa" "tyrsma" {  
		scalar bb = bb + 1
...
svmat m
drop in 1
save						"models_reg.dta", replace
use							"models_reg.dta", clear

*------------------------------------------------------*
* Label data 
*------------------------------------------------------*

label data "This file contains multiverse results for regression coefficient models"
...
save						"models_reg_raw.dta", replace
use							"models_reg_raw.dta", clear
